...
@mixin o-table-typography-fashion($config) {
  .o-table.o-table {
    .o-table-container {
      .o-table-toolbar .buttons .o-table-button .mat-button {
  ...
  .o-form {
    .o-form-toolbar {
      .o-form-toolbar-header {
        ...
        padding: 0 24px;
        font: {
          size: mat-font-size($typography, headline);
          weight: bold;
        }
        ...
        .o-form-navigation {
          span {
            font: {
              size: mat-font-size($typography, subheading-1);
              weight: normal;
            }
          }
        }
...
$accent: mat-palette($default-palette);
