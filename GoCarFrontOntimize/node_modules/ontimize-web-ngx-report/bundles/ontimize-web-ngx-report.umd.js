(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('ontimize-web-ngx'), require('rxjs'), require('@angular/material'), require('@angular/common/http'), require('rxjs/operators'), require('@angular/cdk/drag-drop'), require('@angular/material/dialog'), require('@angular/cdk/collections'), require('@angular/forms'), require('@angular/flex-layout'), require('ngx-extended-pdf-viewer'), require('@angular/common'), require('@angular/router')) :
    typeof define === 'function' && define.amd ? define('ontimize-web-ngx-report', ['exports', '@angular/core', 'ontimize-web-ngx', 'rxjs', '@angular/material', '@angular/common/http', 'rxjs/operators', '@angular/cdk/drag-drop', '@angular/material/dialog', '@angular/cdk/collections', '@angular/forms', '@angular/flex-layout', 'ngx-extended-pdf-viewer', '@angular/common', '@angular/router'], factory) :
    (global = global || self, factory(global['ontimize-web-ngx-report'] = {}, global.ng.core, global['ontimize-web-ngx'], global.rxjs, global.ng.material, global.ng.common.http, global.rxjs.operators, global.ng.cdk['drag-drop'], global.ng.material.dialog, global.ng.cdk.collections, global.ng.forms, global.ng['flex-layout'], global['ngx-extended-pdf-viewer'], global.ng.common, global.ng.router));
}(this, (function (exports, core, ontimizeWebNgx, rxjs, material, http, operators, dragDrop, dialog, collections, forms, flexLayout, ngxExtendedPdfViewer, common, router) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    var OAlertService = /** @class */ (function () {
        function OAlertService() {
            // Observable string
            this.alertSource = new rxjs.Subject();
         ...
         * @return {?}
         */
        OAlertService.prototype.announceAlert = 
        // Service message commands
        /**
         * @param {?} alert
         * @return {?}
    ...
    var OReportService = /** @class */ (function (_super) {
        __extends(OReportService, _super);
        function OReportService(injector) {
            ...
            _this.oErrorDialogManager = injector.get(ontimizeWebNgx.OErrorDialogManager);
            return _this;
        }
        /**
         * @param {?} reportparams
        ...
        function (httpErrorResponse) {
            ...
            if (ontimizeWebNgx.Util.isObject(error)) {
                if (error['code'] === 1 && ontimizeWebNgx.Util.isDefined(error['message'])) {
        ...
        function (files, entity, data) {
            var _this = this;
            /** @type {?} */
            var dataObservable = new ontimizeWebNgx.Observable((/**
             * @param {?} observer
             * @return {?}
             */
            function (observer) {
            ...
            return dataObservable.pipe(operators.share());
        };
        /**
         * @protected
         * @param {?} resp
        ...
        function (_kv, _av, entity, _sqltypes, offset, _pagesize, _orderby) {
            offset = (ontimizeWebNgx.Util.isDefined(offset)) ? offset : this.offset;
            // Calculate page
            /** @type {?} */
            var page = 0;
            if (ontimizeWebNgx.Util.isDefined(offset)) {
        ...
        function () {
            /** @type {?} */
            var headers = new http.HttpHeaders({ 'Access-Control-Allow-Origin': '*' });
            /** @type {?} */
            var sessionId = this.authService.getSessionInfo().id;
            if (ontimizeWebNgx.Util.isDefined(sessionId)) {
        ...
        /** @nocollapse */ OReportService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function OReportService_Factory() { return new OReportService(core.ɵɵinject(core.INJECTOR)); }, token: OReportService, providedIn: "root" });
        return OReportService;
    }(ontimizeWebNgx.OntimizeEEService));
    if (false) {
        /**
         * @type {?}
         * @protected
    ...
    var Utils = /** @class */ (function () {
         ...
         * @return {?}
         */
        Utils.setFullscreenDialog = /**
         * @param {?} fullscreen
         * @param {?} dialogRef
         * @return {?}
         */
        function (fullscreen, dialogRef) {
            if (!fullscreen) {
         ...
         * @return {?}
         */
        Utils.openModalVisor = /**
         * @param {?} dialog
         * @param {?} component
         * @param {?} data
         * @return {?}
         */
        function (dialog, component, data) {
    ...
    var OReportViewerComponent = /** @class */ (function () {
        ...
        OReportViewerComponent.ctorParameters = function () { return [
            ...
            { type: OReportService },
            { type: ontimizeWebNgx.DialogService },
    ...
    var OReportStoreService = /** @class */ (function () {
        function OReportStoreService(injector) {
            ...
            this.dialogService = this.injector.get(ontimizeWebNgx.DialogService);
            this.dialog = this.injector.get(material.MatDialog);
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DefaultOReportPreferences = /** @class */ (function () {
        function DefaultOReportPreferences() {
            this.title = '';
            this.subtitle = '';
            this.vertical = true;
            this.columns = [];
        ...
        return DefaultOReportPreferences;
    }());
    if (false) {
        /** @type {?} */
    ...
    var ApplyConfigurationDialogComponent = /** @class */ (function () {
         ...
         */
        function () {
            this.configurationList.selectedOptions = new collections.SelectionModel(false);
        };
        /**
         * @return {?}
         */
         ...
         */
        function (data) {
            if (ontimizeWebNgx.Util.isArray(data)) {
        ...
        ApplyConfigurationDialogComponent.propDecorators = {
            configurationList: [{ type: core.ViewChild, args: [material.MatSelectionList, { static: true },] }]
        };
    ...
    var SavePreferencesDialogComponent = /** @class */ (function (_super) {
        __extends(SavePreferencesDialogComponent, _super);
    ...
    }(ontimizeWebNgx.OTableBaseDialogClass));
    if (false) {
        /** @type {?} */
    ...
    var SelectFunctionDialogComponent = /** @class */ (function () {
        function SelectFunctionDialogComponent(dialogo, reportFunction) {
            this.dialogo = dialogo;
         ...
         * @return {?}
         */
        SelectFunctionDialogComponent.prototype.save = /**
         * @return {?}
         */
        function () {
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var StyleDialogComponent = /** @class */ (function () {
        function StyleDialogComponent(dialogo, data) {
            this.dialogo = dialogo;
            this.data = data;
            this.dataAlignment = [
            ...
            if (this.reportColumn.columnStyle && !ontimizeWebNgx.Util.isDefined(this.reportColumn.columnStyle.width)) {
                this.reportColumn.columnStyle.width = Constants.DEFAULT_WIDTH_COLUMN_STYLE;
            }
            if (this.reportColumn.columnStyle && !ontimizeWebNgx.Util.isDefined(this.reportColumn.columnStyle.alignment)) {
         ...
         * @return {?}
         */
        StyleDialogComponent.prototype.confirm = /**
         * @return {?}
         */
        function () {
        ...
        /** @nocollapse */
        StyleDialogComponent.ctorParameters = function () { return [
    ...
    var ReportOnDemandComponent = /** @class */ (function () {
        function ReportOnDemandComponent(injector, dialogRef, data) {
            ...
            this.appConfig = this.injector.get(ontimizeWebNgx.AppConfig);
            this.translateService = this.injector.get(ontimizeWebNgx.OTranslateService);
            this.snackBarService = this.injector.get(ontimizeWebNgx.SnackBarService);
            this.reportService = this.injector.get(OReportService);
            this.dialogService = this.injector.get(ontimizeWebNgx.DialogService);
            this.dialog = this.injector.get(dialog.MatDialog);
        }
        /**
         * @return {?}
         */
        ...
        function () {
            /** @type {?} */
            var columnsArray = ontimizeWebNgx.Util.parseArray(this.table.columns);
        ...
        function (columns) {
            ...
            function (column) {
                ...
                if (ontimizeWebNgx.Util.isObject(columnStyle) && Object.keys(columnStyle).length > 0) {
        ...
        function (column) {
            ...
            if (ontimizeWebNgx.Util.isDefined(renderer) && ontimizeWebNgx.Util.isDefined(renderer.type)) {
        ...
        function () {
            ...
            /** @type {?} */
            var pathService;
            if (ontimizeWebNgx.Util.isObject(serviceConfiguration) && serviceConfiguration.hasOwnProperty('path')) {
        ...
        function (event, id) {
            ...
            if (ontimizeWebNgx.Util.isDefined(columnData)) {
                this.dialog
                 ...
                 */
                function (data) {
                    if (ontimizeWebNgx.Util.isDefined(data) && data) {
                        /** @type {?} */
         ...
         */
        function (event) {
            dragDrop.moveItemInArray(this.columnsData, event.previousIndex, event.currentIndex);
         ...
         */
        function (event) {
            dragDrop.moveItemInArray(this.columnsToGroupData, event.previousIndex, event.currentIndex);
         ...
         */
        function (event) {
            dragDrop.moveItemInArray(this.columnsOrderBy, event.previousIndex, event.currentIndex);
        ...
        function () {
            var _this = this;
            if (ontimizeWebNgx.Util.isDefined(this.currentConfiguration.ID)) {
        ...
        function (column) {
            ...
            /** @type {?} */
            var newRenderer;
            if (ontimizeWebNgx.Util.isDefined(oColumn) && ontimizeWebNgx.Util.isDefined(oColumn.type) && oColumn.type !== 'string') {
                /** @type {?} */
                ...
                switch (type) {
                    ...
                    case 'service':
                        ...
                        newRenderer.columns = ontimizeWebNgx.Util.parseArray(columnRenderer.columns);
                        newRenderer.valueColumn = columnRenderer.valueColumn;
                        newRenderer.parentKeys = ontimizeWebNgx.Util.parseArray(columnRenderer.parentKeys);
                        /** @type {?} */
                        var serviceConfiguration = this.getDefaultServiceConfiguration(columnRenderer.service);
                        if (ontimizeWebNgx.Util.isObject(serviceConfiguration) && Object.hasOwnProperty(serviceConfiguration.path)) {
        ...
        ReportOnDemandComponent.ctorParameters = function () { return [
            ...
            { type: ontimizeWebNgx.OTableComponent, decorators: [{ type: core.Inject, args: [dialog.MAT_DIALOG_DATA,] }] }
        ]; };
        ReportOnDemandComponent.propDecorators = {
            columnsList: [{ type: core.ViewChild, args: ['columnsList', { static: false },] }],
            functionsList: [{ type: core.ViewChild, args: ['functionsList', { static: false },] }],
            orderByList: [{ type: core.ViewChild, args: ['orderByList', { static: false },] }]
        };
    ...
    var OntimizeReportService = /** @class */ (function () {
        ...
        /** @nocollapse */ OntimizeReportService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function OntimizeReportService_Factory() { return new OntimizeReportService(core.ɵɵinject(core.INJECTOR)); }, token: OntimizeReportService, providedIn: "root" });
    ...
    /** @type {?} */
    var OREPORT_PROVIDERS = [{ provide: ontimizeWebNgx.O_REPORT_SERVICE, useClass: OntimizeReportService },
        {
            provide: 'report',
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var OReportHomeComponent = /** @class */ (function () {
        function OReportHomeComponent(alertService) {
            var _this = this;
        ...
        /** @nocollapse */
        OReportHomeComponent.ctorParameters = function () { return [
            { type: OAlertService }
        ]; };
        OReportHomeComponent.propDecorators = {
            table: [{ type: core.ViewChild, args: ['table', { static: true },] }]
        };
        return OReportHomeComponent;
    }());
    if (false) {
        /** @type {?} */
    ...
    var OReportNewComponent = /** @class */ (function () {
        ...
        OReportNewComponent.propDecorators = {
            name: [{ type: core.ViewChild, args: ['name', { static: true },] }],
            type: [{ type: core.ViewChild, args: ['type', { static: true },] }],
            description: [{ type: core.ViewChild, args: ['description', { static: true },] }],
            form: [{ type: core.ViewChild, args: ['form', { static: true },] }],
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var OReportDetailComponent = /** @class */ (function () {
        function OReportDetailComponent(dialogService, dialog) {
            this.dialogService = dialogService;
            this.dialog = dialog;
         ...
         * @return {?}
         */
        OReportDetailComponent.prototype.getValues = /**
         * @private
         * @return {?}
         */
        function () {
            for (var i = 0; i < this.parameters.length; i++) {
                /** @type {?} */
                var v = this.paramForm.getFieldValue('value' + i);
                this.values.push(v);
            }
        };
        /**
         * @return {?}
         */
        OReportDetailComponent.prototype.fillReport = /**
         * @return {?}
         */
        function () {
            this.values = [];
         ...
         * @return {?}
         */
        OReportDetailComponent.prototype.onDataLoaded = /**
         * @param {?} e
         * @return {?}
         */
        function (e) {
        ...
        /** @nocollapse */
        OReportDetailComponent.ctorParameters = function () { return [
            { type: ontimizeWebNgx.DialogService },
            { type: material.MatDialog }
        ]; };
        OReportDetailComponent.propDecorators = {
            id: [{ type: core.ViewChild, args: ['id', { static: true },] }],
            paramForm: [{ type: core.ViewChild, args: ['paramForm', { static: false },] }]
        };
        return OReportDetailComponent;
    }());
    if (false) {
        /** @type {?} */
     ...
     */
    /** @type {?} */
    var OREPORT_DECLARATION_MODULES = [
    ...
    /** @type {?} */
    var OREPORT_IMPORTS_MODULES = [
        common.CommonModule,
        ontimizeWebNgx.OntimizeWebModule,
        ngxExtendedPdfViewer.NgxExtendedPdfViewerModule,
        flexLayout.FlexLayoutModule,
        dragDrop.DragDropModule
    ];
    /** @type {?} */
    var OREPORT_EXPORT_MODULES = [];
    /** @type {?} */
    var OREPORT_ENTRY_COMPONENTS_MODULES = [
        OReportViewerComponent,
        ReportOnDemandComponent,
        StyleDialogComponent,
        SelectFunctionDialogComponent,
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var OReportModule = /** @class */ (function () {
        function OReportModule() {
        }
    ...
    var OReportRoutingModule = /** @class */ (function () {
        function OReportRoutingModule() {
        }
    ...
    exports.ApplyConfigurationDialogComponent = ApplyConfigurationDialogComponent;
    exports.DefaultOReportPreferences = DefaultOReportPreferences;
    exports.OReportDetailComponent = OReportDetailComponent;
    exports.OReportHomeComponent = OReportHomeComponent;
    exports.OReportModule = OReportModule;
    exports.OReportNewComponent = OReportNewComponent;
    exports.OReportRoutingModule = OReportRoutingModule;
    exports.OReportService = OReportService;
    exports.OReportStoreService = OReportStoreService;
    exports.OReportViewerComponent = OReportViewerComponent;
    exports.OReportsTranslatePipe = OReportsTranslatePipe;
    exports.OntimizeReportService = OntimizeReportService;
    exports.ReportOnDemandComponent = ReportOnDemandComponent;
    exports.SavePreferencesDialogComponent = SavePreferencesDialogComponent;
    exports.SelectFunctionDialogComponent = SelectFunctionDialogComponent;
    exports.StyleDialogComponent = StyleDialogComponent;
    exports.ɵa = OREPORT_DECLARATION_MODULES;
    exports.ɵb = OREPORT_IMPORTS_MODULES;
    exports.ɵc = OREPORT_ENTRY_COMPONENTS_MODULES;
    exports.ɵd = OAlertService;
    exports.ɵe = reportServiceFactory;
    exports.ɵf = OREPORT_PROVIDERS;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ontimize-web-ngx-report.umd.js.map
